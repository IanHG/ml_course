...
\begin{tikzpicture}
   ...
   \node[invisweight] (H-01) at (-\layersep, 0) {$x_1$};
   \node[invisweight] (H-02) at (-\layersep,-1) {$x_2$};
   \node[invisweight] (H-0M) at (-\layersep,-3) {$x_m$};
   ...
   \node[invisweight] (H-51) at (4*\layersep, 0) {$y_1$};
   \node[invisweight] (H-52) at (4*\layersep,-1) {$y_2$};
   \node[invisweight] (H-5M) at (4*\layersep,-3) {$y_n$};
   ...
   \path (H-1M) edge[arrow,line width=0.3mm] (H-2M);
   ...
   \path (H-2M) edge[arrow,line width=0.3mm]  (H-3M);
   
   \path (H-31) edge[arrow,line width=0.3mm]  (H-41);
   ...
   \path (H-3M) edge[arrow,line width=0.3mm]  (H-4M);
